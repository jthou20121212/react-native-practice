...
import { Image, Text, View, Dimensions, ActivityIndicator, FlatList } from "react-native";

/**
 * React Native 官方提供的 FlatList
 * 
 * @returns 
 */
export default function FixedHeightFl() {
        ...
        return (
            <View
                ...
                <View style={{ flex: 1, flexDirection: 'column', marginTop: 10, marginStart: 14, marginEnd: 16 }}>
                    ...
                    <Text style={{ fontSize: 10, marginTop: 6, color: '#C0C0C0' }} >{data.time} {"  "} {index} {"  fl"} </Text>
                </View>
            </View>
        );
    }
